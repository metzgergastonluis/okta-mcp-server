...
okta SDK 3.4.1 rejects unknown Application.features enum values. Real Springboard
prod apps carry AUTO_CONFIRM_IMPORTS, which breaks list_applications. The patch
relaxes that validator. See docs/superpowers/specs/2026-06-03-okta-mcp-skill-design.md.
"""
